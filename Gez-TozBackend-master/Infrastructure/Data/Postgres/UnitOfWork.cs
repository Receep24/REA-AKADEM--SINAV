...
public class UnitOfWork : IUnitOfWork
{
    ...
    public IBankAccountRepository BankAccount => _bankaccountRepository ??= new BankAccountRepository(_postgresContext);
    public ITransactionRepository Transaction => _transactionRepository ??= new TransactionRepository(_postgresContext);
